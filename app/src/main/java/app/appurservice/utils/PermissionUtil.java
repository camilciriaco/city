package app.appurservice.utils;
...
import app.appurservice.ActivityMaps;
...
public abstract class PermissionUtil {
    ...
    public static boolean isGroupPermissionGranted(ActivityMaps activity, String[] permission) {
